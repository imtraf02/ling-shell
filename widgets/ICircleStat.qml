...
Rectangle {
  ...
  property real valueFontSize: Style.font.size.small * 0.9
  property real iconSize: Style.font.size.small
  ...
  ColumnLayout {
    id: mainLayout
    anchors.fill: parent
    anchors.margins: Style.padding.small * root.contentScale
    spacing: 0
    ...
    Item {
      ...
      IText {
        ...
        font.pointSize: root.valueFontSize * root.contentScale
      ...
      IIcon {
        ...
        font.pointSize: root.iconSize * root.contentScale
        horizontalAlignment: Text.AlignHCenter
