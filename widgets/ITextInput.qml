...
ColumnLayout {
  ...
  Control {
    ...
    implicitHeight: Style.widget.size * 1.1
    ...
    contentItem: Item {
      ...
      MouseArea {
        ...
        onPressed: mouse => {
          ...
          if (inputPos.x >= 0 && inputPos.x <= inputContainer.width) {
            var textPos = inputPos.x - Style.padding.larger;
      ...
      Item {
        id: inputContainer
        anchors.fill: parent
        anchors.leftMargin: Style.padding.larger
        clip: true
        z: 1
        ...
        RowLayout {
          ...
          IIcon {
            ...
            Layout.rightMargin: visible ? Style.spacing.small : 0
          }
