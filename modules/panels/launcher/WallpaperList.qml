...
Item {
  ...
  component WallpaperScreenView: PathView {
    ...
    readonly property int itemWidth: Style.launcher.wallpaperWidth * 0.8 + Style.padding.larger * 2
    ...
    delegate: Item {
      ...
      implicitWidth: image.width + Style.padding.larger * 2
