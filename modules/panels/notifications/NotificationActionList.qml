    ...
    RowLayout {
      ...
      Repeater {
        ...
        Rectangle {
          ...
          implicitWidth: actionInner.implicitWidth + Style.padding.small * 2
          implicitHeight: actionInner.implicitHeight + Style.padding.small * 2

          Layout.preferredWidth: implicitWidth + (actionStateLayer.pressed ? Style.padding.large : 0)
          radius: actionStateLayer.pressed ? Style.rounding.small / 2 : Style.rounding.small
