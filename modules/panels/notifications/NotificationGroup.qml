...
Rectangle {
  ...
  RowLayout {
    ...
    ColumnLayout {
      ...
      Layout.bottomMargin: -Style.padding.small / 2
      ...
      RowLayout {
        ...
        Layout.bottomMargin: root.expanded ? Math.round(Style.spacing.small / 2) : 0
        Layout.fillWidth: true
        ...
        Rectangle {
          implicitWidth: expandBtn.implicitWidth + Style.padding.smaller * 2
          implicitHeight: groupCount.implicitHeight + Style.padding.small
          ...
          RowLayout {
            ...
            IText {
              ...
              Layout.leftMargin: Style.padding.small / 2
              animate: true
            ...
            IIcon {
              Layout.rightMargin: -Style.padding.small / 2
              icon: "expand_more"
              color: root.urgency === NotificationUrgency.Critical ? ThemeService.palette.mOnError : ThemeService.palette.mOnSurface
              rotation: root.expanded ? 180 : 0
              Layout.topMargin: root.expanded ? -Math.floor(Style.padding.smaller / 2) : 0
