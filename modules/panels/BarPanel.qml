...
Item {
  ...
  opacity: isClosing ? 0.0 : (isPanelVisible && sizeAnimationComplete ? 1.0 : 0.0)
  ...
  Item {
    ...
    Item {
      ...
      readonly property int topLeftCornerState: targetY <= 0 ? 1 : 0
      readonly property int topRightCornerState: targetY <= 0 ? 1 : 0
      readonly property int bottomLeftCornerState: targetX <= 1 ? 2 : 0
      readonly property int bottomRightCornerState: targetX + width + 1 >= root.width ? 2 : 0
