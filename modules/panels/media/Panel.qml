...
SmartPanel {
  ...
  panelContent: Item {
    ...
    readonly property real contentPreferredWidth: Style.bar.mediaWidth
    readonly property real contentPreferredHeight: Style.bar.mediaWidth * 9 / 16 + (Style.padding.small * 2)
    ...
    IBox {
      ...
      ColumnLayout {
          ...
          Item {
            ...
            ColumnLayout {
              ...
              Item {
                ...
                Layout.preferredWidth: Style.font.size.extraLarge * 4
                Layout.preferredHeight: Style.font.size.extraLarge * 4
        ...
        ColumnLayout {
          ...
          Item {
            Layout.preferredHeight: Style.spacing.small
          }
