...
SmartPanel {
  ...
  panelContent: Item {
    ...
    readonly property real contentPreferredWidth: Style.bar.brightnessWidth
          ...
          ColumnLayout {
            ...
            ILabel {
              ...
              description: {
                ...
                return `${box.modelData.model} (${box.modelData.width * compositorScale}x
${box.modelData.height * compositorScale} @ ${compositorScale}x)`;
              }
            }
