...
Rectangle {
  ...
  MouseArea {
    ...
    Item {
      ...
      Loader {
        ...
        sourceComponent: Rectangle {
          ...
          Loader {
            ...
            asynchronous: true
            anchors.centerIn: parent
            anchors.horizontalCenterOffset: -Style.font.size.large * 0.02
            anchors.verticalCenterOffset: Style.font.size.large * 0.02
      ...
      TextMetrics {
        ...
        elideWidth: expandBtn.x - time.width - timeSep.width - summary.x - Style.spacing.small * 3
      }
  ...
  component Action: Rectangle {
    ...
    Layout.preferredHeight: actionText.height + Style.padding.small * 2
    implicitWidth: actionText.width + Style.padding.small * 2
    ...
    TextMetrics {
      ...
      elideWidth: {
        ...
        return (inner.width - actions.spacing * (numActions - 1)) / numActions - Style.padding.small * 2;
      }
    }
  }
}
