...
ColumnLayout {
  ...
  RowLayout {
    ...
    IText {
      ...
      font.pointSize: Math.floor(Style.font.size.extraLarge * 3 * root.centerScale)
    ...
    Loader {
      ...
      sourceComponent: IText {
        ...
        color: ThemeService.palette.mPrimary
        font.pointSize: Math.floor(Style.font.size.extraLarge * 2 * root.centerScale)
        font.family: Settings.appearance.font.clock
        font.bold: true
      }
    }
  ...
  IText {
    Layout.alignment: Qt.AlignHCenter
    Layout.topMargin: -Style.padding.large * 2
    text: TimeService.format("dddd, d MMMM yyyy")
    color: ThemeService.palette.mTertiary
    font.pointSize: Math.floor(Style.font.size.extraLarge * root.centerScale)
    font.family: Settings.appearance.font.mono
    font.bold: true
  }

  IImageCircled {
    Layout.topMargin: Style.spacing.large * 2
    Layout.alignment: Qt.AlignHCenter
  ...
  Rectangle {
    ...
    implicitHeight: input.implicitHeight + Style.padding.small * 2
    ...
    RowLayout {
      ...
      Item {
        ...
        implicitHeight: fprintIcon.implicitHeight + Style.padding.small * 2
      ...
      Rectangle {
        implicitWidth: implicitHeight
        implicitHeight: enterIcon.implicitHeight + Style.padding.small * 2
