...
WlSessionLockSurface {
  ...
  Item {
    ...
    IIcon {
      ...
      anchors.centerIn: parent
      icon: "lock"
      font.pointSize: Style.font.size.extraLarge * 4
      font.bold: true
      rotation: 180
    }
    ...
    Content {
      ...
      anchors.centerIn: parent
      width: (root.screen?.height ?? 0) * Style.lock.heightMult * Style.lock.ratio - Style.padding.large * 2
      height: (root.screen?.height ?? 0) * Style.lock.heightMult - Style.padding.large * 2
